---
title: Set your default branch to `main` with .gitconfig
publishedAt: 2023-02-26
excerpt: Guide to switch the default branch from `master` to `main` so you don't have to do it everytime
---
