...
| Frontend                                                                                                                                                | API                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Singapore EV Trends Frontend](https://singapore-ev-trends.ruchern.xyz) <br/> [GitHub Source Code](https://github.com/ruchernchong/singapore-ev-trends) | [Singapore EV Trends API](https://api.singapore-ev-trends.ruchern.xyz) <br/> [GitHub Source Code](https://github.com/ruchernchong/lta-cars-dataset) |
