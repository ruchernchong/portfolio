---
title: Enhance content sharing on mobile browsers using Web Share API
publishedAt: 2023-01-19
excerpt: Using Web Share API to trigger iOS or Android system level sharing sheet; enhancing the user experience of sharing.
---
